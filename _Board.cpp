...
void _Board::drawBoard3()
{
	...
	_Common::gotoXY(56, 18); cout << char(201);
	_Common::gotoXY(56 + size * 4, 18); cout << char(187);

	// Ve dong cuoi
	_Common::gotoXY(56, size * 2 + 18);
	for (int i = 0; i < size * 4; i++)
	{
		Sleep(1);
		if (i % 4 == 0)
	...
	_Common::gotoXY(56, size * 2 + 18); cout << char(200);
	_Common::gotoXY(size * 4 + 56, size * 2 + 18);
	cout << char(188);	
	//===========================
	_Common::gotoXY(_pArr[0][0].getX(), _pArr[0][0].getY());
}

void _Board::drawBoard5()
{
	if (_size == 0) return;
	int size = 5;
	Textcolor(DarkWhite);
	...
	_Common::gotoXY(52, 15); cout << char(201);
	_Common::gotoXY(52 + size * 4, 15); cout << char(187);

	// Ve dong cuoi
	_Common::gotoXY(52, size * 2 + 15);
	for (int i = 0; i < size * 4; i++)
	{
		Sleep(1);
		if (i % 4 == 0)
	...
	_Common::gotoXY(52, size * 2 + 15); cout << char(200);
	_Common::gotoXY(size * 4 + 52, size * 2 + 15);
	cout << char(188);	
	//===========================
	_Common::gotoXY(_pArr[0][0].getX(), _pArr[0][0].getY());
}

void _Board::drawBoard7() 
{
	if (_size == 0) return;
	int size = 7;
	Textcolor(DarkWhite);
	...
	_Common::gotoXY(48, 14); cout << char(201);
	_Common::gotoXY(48 + size * 4, 14); cout << char(187);

	// Ve dong cuoi
	_Common::gotoXY(48, size * 2 + 14);
	for (int i = 0; i < size * 4; i++)
	{
		Sleep(1);
		if (i % 4 == 0)
	...
	_Common::gotoXY(48, size * 2 + 14); cout << char(200);
	_Common::gotoXY(size * 4 + 48, size * 2 + 14);
	cout << char(188);	
	//===========================
	_Common::gotoXY(_pArr[0][0].getX(), _pArr[0][0].getY());
}
...
int _Board::checkWinRow(int x, int y, int value)
{
	...
	if (_pArr[cot][dongtrai].getCheck() == -value && _pArr[cot][dongphai].getCheck() == -value)
		check2dau = 1;
	if (_size == 3) {
		if ((countRowLeft + countRowRight - 1) == 3)
			test = 1;
		else
			test = 0;
	}
...
int _Board::checkWinCol(int x, int y, int value) // Xet chien thang theo hang doc
{
	...
	if (_pArr[cottren][dong].getCheck() == -value && _pArr[cotduoi][dong].getCheck() == -value)
		check2dau = 1;
	if (_size == 3) {
		if ((countColTop + countColBot - 1) == 3)
			test = 1;
		else
			test = 0;
	}
...
int _Board::checksecondDiagonal(int x, int y, int value)
{
	...
	if (_pArr[cottren][dongtrai].getCheck() == -value && _pArr[cotduoi][dongphai].getCheck() == -value)
		check2dau = 1;
	if (_size == 3) {
		if ((countDiaTop + countDiaBot - 1) == 3)
			test = 1;
		else
			test = 0;
	}
...
int _Board::testBoard(int x,int y, int size)
{
	// X chien thang
...
_Point _Board::Tim_Kiem_NuocDi_1(int size)
{
	_Point Oco ;
	int dong=0, cot=0;
	long Diem = 0;
	...
	if (_size == 3) {
		Oco.setX(cot*4+2 + 56);
		Oco.setY(dong*2+1 + 18);
	}
	if (_size == 5) {
		Oco.setX(cot*4+2 + 52);
		Oco.setY(dong*2+1 + 15);
	}
	if (_size == 7) {
		Oco.setX(cot*4+2 + 48);
		Oco.setY(dong*2+1 + 14);
	}
	return Oco;
}
_Point _Board::Tim_Kiem_NuocDi_2(int size)
{
	_Point Oco;
	int dong = 0, cot = 0;
	long Diem = 0;
...
_Point _Board::Tim_Kiem_NuocDi_3(int size)
{
	_Point Oco ;
	int dong=0, cot=0;
	long Diem = 0;
